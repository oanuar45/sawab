...
class APrayer extends StatefulWidget {
  const APrayer({super.key});
  @override
  State<APrayer> createState() => _APrayerState();
}

class _APrayerState extends State<APrayer> {
  ...
  double x = 0.0;
  double y = 0.0;
  late PdfViewerController _pdfViwerCtrl;
  ...
  @override
  void initState() {
    _pdfViwerCtrl = PdfViewerController();
    print('============= ' + _pdfViwerCtrl.pageCount.toString());
    super.initState();
  }

  @override
  dispose() {
    _pdfViwerCtrl.dispose();
    super.dispose();
  }
          ...
          child: GestureDetector(
            child: Center(
              child: SfPdfViewer.asset(
                'lib/assets/pdf/Namaz-3.pdf',
                controller: _pdfViwerCtrl,
